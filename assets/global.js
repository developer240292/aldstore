document.addEventListener('click', function (event) {
    ...
    const dropdownParent = target.closest('.aldstore-dropdown');
    const allDropdowns = document.querySelectorAll('.aldstore-dropdown');
    ...
    if (dropdownParent) {
        ...
        const isToggle =
            target.matches('[data-aldstore="aldstore-dropdown"]') ||
            target.closest('[data-aldstore="aldstore-dropdown"]');

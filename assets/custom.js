jQuery(document).ready(function ($) {
    ...
    function aldstore_vertical_menu($elem) {
    ...
    if ($('.block-nav-category').length) {
        aldstore_vertical_menu($('.block-nav-category'));
    }

    function aldstore_header_sticky($elem) {
        var $this = $elem;
        $this.on('aldstore_header_sticky', function () {
            $this.each(function () {
        ...
        }).trigger('aldstore_header_sticky');
        $(window).on('resize', function () {
            $this.trigger('aldstore_header_sticky');
        });
    }

    if ($('.header-sticky .header-desktop-wrap').length) {
        aldstore_header_sticky($('.header-sticky .header-desktop-wrap'));
    }

    if ($('.header-mobile-sticky .header-mobile-wrap').length) {
        aldstore_header_sticky($('.header-mobile-sticky .header-mobile-wrap'));
    }
